        ...
        <div class="box-header">
          <h3 class="box-title">List of categories</h3>
              ...
              <p style="text-align: center;">
                <a href="{{route('admin.post_cat.add')}}" class="addtop"><img src="assets/img/add.png" alt="" /> 
        ...
        <tbody>
          @foreach($oItems as $Item)
            @php
              ...
              $urlEdit   =   route('admin.post_cat.edit', [$cat_id]);
              $urlDel    =   route('admin.post_cat.del', [$cat_id]);
            @endphp
          <tr>
            <td>{{$cat_id}}</td>
            <td>{{$cat_name}}</td>
