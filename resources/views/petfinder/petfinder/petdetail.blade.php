                        ...
                        <div class="col-md-9 col-sm-12">
                          <article class="cp-blog-item">
                            <figure class="cp-thumb">
                              <img style="width: 100%; height: 430px; object-fit: cover !important;" src="{{$PIC_URL}}{{$arPet->avatar}}" alt="">
                              </figure>
                              <div class="cp-text">
                                <div class="cp-date-box">
                                  <span style="font-size: 18px !important">Age</span>{{$arPet->age}}
                                </div>
                                <div class="cp-inner">
                                  <h3>{{$arPet->pet_name}}</h3>
                                  <div class="cp-top">
                                    <ul class="cp-meta-listed">
                                      ...
                                      <li>
                                        <i  class="fa fa-check-square" aria-hidden="true"> </i>
                                        <a href="#">{{$arPet->gender}}</a>
                                      </li>
                                      <li>
                                        <i style="padding-left: 10px" class="fa fa-check-square" aria-hidden="true"> </i>
                                        <a href="#">{{$arPet->address}}</a>
                                      </li>
                                    </ul>
                                    <ul class="right-nav">
                                      <li class="">
                                  ...
                                  <p style="font-style: italic; font-weight: bold;"><?php echo $arPet->discription; ?></p>
