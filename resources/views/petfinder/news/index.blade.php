                  ...
                  <div class="row">
                    ...
                    <div class="  col-md-3 columns" >
                      <div   class="  kode-service-type-1" >
                        <div style="background:#58dd00" class="kf_pet_service_wrap">
                          <i class="icon-animal614 "></i>
                          <h4>DOG WALKING</h4>
                          <p style="color:#ffffff">Fun &#038; active dog walking service</p>
                          <a class="kf_pet_link_1 pet_sm_link" href="#">Read More</a>
                        </div>
                      </div>
                    </div>
                    <div class="  col-md-3 columns" >
                      <div   class="  kode-service-type-1" >
                        <div style="background:#f52626" class="kf_pet_service_wrap">
                          <i class="icon-hairdresser22"></i>
                          <h4>CAT FEEDING</h4>
                          <p style="color:#ffffff">Cat feeding services by cat lover</p>
                          <a class="kf_pet_link_1 pet_sm_link" href="#">Read More</a>
                        </div>
                      </div>
                    </div>
                    <div class="  col-md-3 columns" >
                      <div   class="  kode-service-type-1" >
                        <div style="background:#f29100" class="kf_pet_service_wrap">
                          <i class="icon-hairdresser22"></i>
                          <h4>GROOMING</h4>
                          <p style="color:#ffffff">Fully qualified grooming service</p>
                          <a class="kf_pet_link_1 pet_sm_link" href="#">Read More</a>
                        </div>
                      </div>
                    </div>
                    <div class="  col-md-3 columns" >
                      <div   class="  kode-service-type-1" >
                        <div style="background:#38cddc" class="kf_pet_service_wrap">
                      ...
                      <div class="row">
                        <div class="col-md-4 columns">
                          <div class="kf_pet_looking_wrap ">
                            <figure>
                              <img width="350" height="350" src="{{$PUBLIC_URL}}img/pet_services_new4-350x350.jpg" class="attachment-kode-team-size size-kode-team-size wp-post-image" alt="" srcset="{{$PUBLIC_URL}}img/pet_services_new4-350x350.jpg 350w, {{$PUBLIC_URL}}img/pet_services_new4-150x150.jpg 150w, {{$PUBLIC_URL}}img/pet_services_new4-300x300.jpg 300w, {{$PUBLIC_URL}}img/pet_services_new4-180x180.jpg 180w, {{$PUBLIC_URL}}img/pet_services_new4-600x600.jpg 600w, {{$PUBLIC_URL}}img/pet_services_new4.jpg 614w" sizes="(max-width: 350px) 100vw, 350px" />
                            </figure>
                            <div class="kf_pet_looking_des">
                              <div class="kf_looking_icon kf_pet_bg2">
                                <i class="icon-horse125"></i>
                              </div>
                        ...
                        <div class="col-md-4 columns">
                          <div class="kf_pet_looking_wrap ">
                            <figure>
                              <img width="350" height="350" src="{{$PUBLIC_URL}}img/pet_services_new2-350x350.jpg" class="attachment-kode-team-size size-kode-team-size wp-post-image" alt="" srcset="{{$PUBLIC_URL}}img/pet_services_new2-350x350.jpg 350w, {{$PUBLIC_URL}}img/pet_services_new2-150x150.jpg 150w, {{$PUBLIC_URL}}img/pet_services_new2-300x300.jpg 300w, {{$PUBLIC_URL}}img/pet_services_new2-180x180.jpg 180w, {{$PUBLIC_URL}}img/pet_services_new2-600x600.jpg 600w, {{$PUBLIC_URL}}img/pet_services_new2.jpg 614w" sizes="(max-width: 350px) 100vw, 350px" />
                            </figure>
                            <div class="kf_pet_looking_des">
                              <div class="kf_looking_icon kf_pet_bg2">
                                <i class="icon-squirrel2"></i>
                              </div>
                              <div class="kf_pet_looking_heading">
                                <h5>DE SHEDDING</h5>
                                <p>Lorem Ipsum is simply dum</p>
                            ...
                            <div class="kf_looking_hover_wrap">
                              <h5>DE SHEDDING</h5>
                              <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem</p>
                              <a href="http://kodeforest.net/wp-demo/petcare/services/charlie-2-3-3-6/" class="kf_pet_link_1 pet_sm_link">Learn More</a>
                            </div>
                          </div>
                        </div>
                        <div class="col-md-4 columns">
                          <div class="kf_pet_looking_wrap ">
                            <figure>
                              <img width="350" height="350" src="{{$PUBLIC_URL}}img/pet_services_new1-350x350.jpg" class="attachment-kode-team-size size-kode-team-size wp-post-image" alt="" srcset="{{$PUBLIC_URL}}img/pet_services_new1-350x350.jpg 350w, {{$PUBLIC_URL}}img/pet_services_new1-150x150.jpg 150w, {{$PUBLIC_URL}}img/pet_services_new1-300x300.jpg 300w, {{$PUBLIC_URL}}img/pet_services_new1-180x180.jpg 180w, {{$PUBLIC_URL}}img/pet_services_new1-600x600.jpg 600w, {{$PUBLIC_URL}}img/pet_services_new1.jpg 614w" sizes="(max-width: 350px) 100vw, 350px" />
                            </figure>
                            <div class="kf_pet_looking_des">
                              <div class="kf_looking_icon kf_pet_bg2">
                                <i class="icon-animal614"></i>
                            ...
                            <div class="kf_looking_hover_wrap">
                              <h5>BATHS</h5>
                              <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem</p>
                              <a href="http://kodeforest.net/wp-demo/petcare/services/charlie-2-3-3-5/" class="kf_pet_link_1 pet_sm_link">Learn More</a>
                            </div>
                          </div>
                        </div>
                        <div class="col-md-4 columns">
                          <div class="kf_pet_looking_wrap ">
                            <figure>
                              <img width="350" height="350" src="{{$PUBLIC_URL}}img/pet_services_new5-350x350.jpg" class="attachment-kode-team-size size-kode-team-size wp-post-image" alt="" srcset="{{$PUBLIC_URL}}img/pet_services_new5-350x350.jpg 350w, {{$PUBLIC_URL}}img/pet_services_new5-150x150.jpg 150w, {{$PUBLIC_URL}}img/pet_services_new5-300x300.jpg 300w, {{$PUBLIC_URL}}img/pet_services_new5-180x180.jpg 180w, {{$PUBLIC_URL}}img/pet_services_new5-600x600.jpg 600w, {{$PUBLIC_URL}}img/pet_services_new5.jpg 614w" sizes="(max-width: 350px) 100vw, 350px" />
                            </figure>
                            <div class="kf_pet_looking_des">
                              <div class="kf_looking_icon kf_pet_bg2">
                            ...
                            <div class="kf_looking_hover_wrap">
                              <h5>PET ADOPTION</h5>
                              <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem</p>
                              <a href="http://kodeforest.net/wp-demo/petcare/services/charlie-2-3-3-4/" class="kf_pet_link_1 pet_sm_link">Learn More</a>
                            </div>
                          </div>
                        </div>
                        <div class="col-md-4 columns">
                          <div class="kf_pet_looking_wrap ">
                            <figure>
                              <img width="350" height="350" src="{{$PUBLIC_URL}}img/pet_services_new3-350x350.jpg" class="attachment-kode-team-size size-kode-team-size wp-post-image" alt="" srcset="{{$PUBLIC_URL}}img/pet_services_new3-350x350.jpg 350w, {{$PUBLIC_URL}}img/pet_services_new3-150x150.jpg 150w, {{$PUBLIC_URL}}img/pet_services_new3-300x300.jpg 300w, {{$PUBLIC_URL}}img/pet_services_new3-180x180.jpg 180w, {{$PUBLIC_URL}}img/pet_services_new3-600x600.jpg 600w, {{$PUBLIC_URL}}img/pet_services_new3.jpg 614w" sizes="(max-width: 350px) 100vw, 350px" />
                            </figure>
                            <div class="kf_pet_looking_des">
                              <div class="kf_looking_icon kf_pet_bg2">
                                <i class="icon-pet25"></i>
                              </div>
                              <div class="kf_pet_looking_heading">
                                <h5>BRUSH TEETH</h5>
                                <p>Lorem Ipsum is simply dum</p>
                            ...
                            <div class="kf_looking_hover_wrap">
                              <h5>BRUSH TEETH</h5>
                              <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem</p>
                              <a href="http://kodeforest.net/wp-demo/petcare/services/charlie-2-3-3-3/" class="kf_pet_link_1 pet_sm_link">Learn More</a>
                            </div>
                          </div>
                        </div>
                        <div class="col-md-4 columns">
                          <div class="kf_pet_looking_wrap ">
                            <figure>
                              <img width="350" height="350" src="{{$PUBLIC_URL}}img/pet_services_new6-350x350.jpg" class="attachment-kode-team-size size-kode-team-size wp-post-image" alt="" srcset="{{$PUBLIC_URL}}img/pet_services_new6-350x350.jpg 350w, {{$PUBLIC_URL}}img/pet_services_new6-150x150.jpg 150w, {{$PUBLIC_URL}}img/pet_services_new6-300x300.jpg 300w, {{$PUBLIC_URL}}img/pet_services_new6-180x180.jpg 180w, {{$PUBLIC_URL}}img/pet_services_new6-600x600.jpg 600w, {{$PUBLIC_URL}}img/pet_services_new6.jpg 614w" sizes="(max-width: 350px) 100vw, 350px" />
                            </figure>
                            <div class="kf_pet_looking_des">
                              <div class="kf_looking_icon kf_pet_bg2">
                            ...
                            <div class="kf_looking_hover_wrap">
                              <h5>ANNUAL GRAND EXPRESSON</h5>
                              <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem</p>
                              <a href="http://kodeforest.net/wp-demo/petcare/services/charlie-2-3-3-2/" class="kf_pet_link_1 pet_sm_link">Learn More</a>
                            </div>
                          </div>
                        </div>
                      </div>
