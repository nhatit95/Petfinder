            ...
            <div class="">
                <div class="">
                    ...
                    <div class="content">
                        ...
                        <form role="form" action="{{ route('petfinder.profile.petedit', ['id' => $oItem->pet_id]) }}" method="post" enctype="multipart/form-data">
                            {{csrf_field()}}
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input style="margin-left: 10px" type="file" name="newPicture" placeholder="Choose your picture" value="Choose your picture" />
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea style="margin-left: 10px" class="ckeditor" id="discription" required="true" rows="5" name="discription">{{$oItem->discription}}</textarea>
                                    <script>
