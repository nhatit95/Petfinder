...
{
    public function __construct(post_cat $mCat){
        $this->mCat = $mCat;
    }

    public function index(){
        $oItems = $this->mCat->getItems();
    	return view('admin.post_cat.index', compact('oItems'));
    }
    ...
    public function postAdd(Request $request){
        ...
        return redirect()->route('admin.post_cat.index');
    }

    public function getEdit($id, Request $request){
        $oItem = $this->mCat->getItem($id);
        return view('admin.post_cat.edit', compact('oItem'));
    }
